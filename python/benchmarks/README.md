...
The bar chart in [`docs/benchmarks.md`](../../docs/benchmarks.md) is a Vega-Lite spec rendered to SVG.
[`chart.vl.json`](./chart.vl.json) is the source of truth: update the `data.values` entries with the new hyperfine means, then render both color schemes with
